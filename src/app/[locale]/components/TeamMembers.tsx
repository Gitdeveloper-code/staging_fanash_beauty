...
export const TeamMembers = ({ name, design, description }: TeamProps) => {
    return (
        <div className="py-4 px-2 mx-auto max-w-screen-xl lg:py-8 lg:px-4">
            <div className="bg-gray-50 rounded-lg shadow-lg sm:flex sm:max-w-xl dark:bg-gray-800 dark:border-gray-700 " >
                ...
                <div className="p-4 flex flex-col justify-between sm:px-6">
                    <div>
                        <h3 className="text-lg font-bold tracking-tight text-gray-900 dark:text-white">
                            <Link href="#">{name}</Link>
                        </h3>
                        <span className="text-sm text-gray-500 dark:text-gray-400">{design}</span>
