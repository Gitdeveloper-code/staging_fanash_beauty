...
const StickyButton = ({ icon, action }: ButtonProps) => {
    ...
    return (
        <div>
            ...
            {iframeVisible && (
                <div className="fixed bottom-14 right-4 md:right-[1rem] flex items-center  shadow z-30  md:w-[31%] md:h-[80vh] rounded-md">
                    {/* Close button */}
                    <button
                    ...
                    <iframe
                        ...
                        className="w-full h-[90vh] md:w-[100%] md:h-[80vh] rounded-md"
                    ></iframe>
                </div>
            )}
        </div>
