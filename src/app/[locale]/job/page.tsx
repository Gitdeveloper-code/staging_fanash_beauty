        ...
        >
          <div className="flex flex-col md:flex-row justify-between m-2">
            <div className="md:mr-5 mb-5 md:mb-0">
              <h3 className="inline-block px-2.5 py-1 text-sm text-white font-medium bg-tertiary uppercase rounded-md mb-2 md:mb-4">
                {/* {item.category} */}
               {job("beautician")}
              </h3>
              ...
              {/* <p>{item.type}</p> */}
              <h3 className="text-xl text-black font-heading mb-2.5 font-bold leading-snug">
              {job("jobtype")}
              </h3>
              <h4 className="text-lg text-black mb-2.5 font-bold leading-snug">
              ...
              <h4 className="text-base text-black mb-2.5">
